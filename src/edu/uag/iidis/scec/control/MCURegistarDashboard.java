...
public final class MCURegistrarDashboard
        extends MappingDispatchAction {

    private Log log = LogFactory.getLog(MCURegistrarDashboard.class);
    ...
    public ActionForward procesarRegistroDashboard(
                ActionMapping mapping,
                ActionForm form,
                HttpServletRequest request,
                HttpServletResponse response)
        ...
        if (log.isDebugEnabled()) {
            log.debug(">procesarRegistroDashboard");
        }
        ...
        //
        FormaDashboard forma = (FormaDashboard)form;

        Dashboard params  = new Dashboard(
            forma.getNameList(), //get + name del input
            forma.getItemList());
